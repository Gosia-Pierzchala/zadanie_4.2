public class Method {
    ...
    void findLonger (Line line1, Line line2){
        if((line1.pointE - line1.pointS) > (line2.pointE - line2.pointS)){
            ...
            System.out.println("Odcinki są równe.\n" + "Początek pierwszego odcinka: " + line1.pointS + ", " + "Koniec pierwszego odcinka: " + line1.pointE + ", " + "Długość pierwszego odcinka: " + (line1.pointE - line1.pointS) + "\n" + "Początek drugiego odcinka: " + line2.pointS + ", " + "Koniec drugiego odcinka: " + line2.pointE + ", " + "Długość drugiego odcinka: " + (line2.pointE - line2.pointS));
        } else {
